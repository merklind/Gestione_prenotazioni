...
def future_reservation():
    ...
    for number_reservation in range(start_row_riepilogo, end_row_riepilogo):
        ...
        if state.lower() not in ['cancellata', 'fittizia']:
            ...
            if date_check_in >= today:
                ...
                set_rendiconto_gross_cell(ws_rendiconto, ws_riepilogo, gross_column, start_column_price,
                                          start_row_rendiconto, number_reservation, info_reservation)
            ...
            if date_check_in < today < date_check_out:
                set_cell_reservation_break(ws_rendiconto, start_row_rendiconto, info_reservation, taken_column,
                                           gross_column,
